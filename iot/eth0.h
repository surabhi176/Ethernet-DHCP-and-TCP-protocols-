...
struct _dhcpoffer
{
    uint8_t etherAdd[HW_ADD_LENGTH];
    uint8_t ipAdd[IP_ADD_LENGTH];
    uint8_t DhcpYiAdd[IP_ADD_LENGTH];
    uint8_t DhcpGiAdd[IP_ADD_LENGTH];
    uint8_t DhcpSiAdd[IP_ADD_LENGTH];
    uint8_t DhcpSerId[IP_ADD_LENGTH];
    int32_t DhcpOffLeaseTime;
    uint8_t DhcpSn[IP_ADD_LENGTH];
    uint8_t DhcpRout[IP_ADD_LENGTH];
}dhcpoffer;

struct dhcpack_
{
    uint8_t DHCPipAdd[IP_ADD_LENGTH];
    uint8_t DHCPgwAdd[IP_ADD_LENGTH];
    uint8_t DHCPSn[IP_ADD_LENGTH];
}dhcpack;
